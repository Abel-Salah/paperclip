...
The default `--all` selection is 162 cells (139 local and 23 Daytona) and 350
...
integer from 1–100 on AWS (default 100). The 162-cell default selection takes more than
