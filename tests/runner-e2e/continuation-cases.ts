...
export function continuationScenario(id: string, nonce: string) {
  ...
  const document =
    "Save the final note as a task document with key output. No other deliverables or child tasks are needed.";
